  ...
  tagList(
    logo_footer = tagList(
      ...
      absolutePanel(left = 20, fixed=F, draggable = FALSE, height = "auto",
                    tags$a(href='https://drexel.edu/lac/salurbal/overview/',target = "_blank", tags$img(src='SALURBAL_logo1.jpg',height='80'))),
      absolutePanel(left = 140, fixed=F, draggable = FALSE, height = "auto",
                    tags$a(href='https://drexel.edu/uhc/', target = "_blank", tags$img(src='UHC_logo.png',height='80'))),
      br(),br(),br(),br(),br()
